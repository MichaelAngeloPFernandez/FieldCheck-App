              ...
              child: Card(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          color: _getStatusColorValue(_userProfile!.isVerified ? 'active' : 'pending')
                .withValues(alpha: 0.1),
                        ...
                        child: Row(
                          children: [
                            Icon(
                              _userProfile!.isVerified ? Icons.check_circle : Icons.pending,
                              color: _getStatusColorValue(
                                _userProfile!.isVerified ? 'active' : 'pending',
                              ),
                            ),
                            ...
                            Column(
                              ...
                              children: [
                                Text(
                                  _userProfile!.isVerified ? 'Active ✓' : 'Pending Verification',
                                  style: TextStyle(
                                    fontWeight: FontWeight.bold,
                                    color: _getStatusColorValue(
                                      _userProfile!.isVerified ? 'active' : 'pending',
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 16),
                      _buildProfileField('Full Name', _nameController, Icons.person, _isEditing),
                      const SizedBox(height: 12),
                      _buildProfileField('Email', _emailController, Icons.email, _isEditing),
                      const SizedBox(height: 12),
                      _buildProfileField('Username', _usernameController, Icons.account_box, _isEditing),
                      if (_isEditing) ...[
                        const SizedBox(height: 16),
                        SizedBox(
                          width: double.infinity,
          ...
          Container(
            ...
            child: Row(
              children: [
                ...
                const SizedBox(width: 12),
                Expanded(
                  child: Text(controller.text.isNotEmpty ? controller.text : 'Not set'),
                ),
              ],
            ),
          ),
