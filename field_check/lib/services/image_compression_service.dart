...
class ImageCompressionService {
  ...
  static Future<File> compressImage(
    ...
    try {
      ...
      debugPrint('📷 Compressing image: ${originalSize.toStringAsFixed(1)}KB');
      ...
      if (image.width > maxWidth || image.height > maxHeight) {
        ...
        debugPrint('↙️  Resized to: ${compressed.width}x${compressed.height}');
      }
      ...
      if (optimizeQuality) {
        ...
        debugPrint('⚙️  Quality optimized: $quality%');
      }
      ...
      final ratio = ((1 - (compressedSize / originalSize)) * 100)
          .toStringAsFixed(0);
      debugPrint(
        '✅ Compressed: ${compressedSize.toStringAsFixed(1)}KB (-$ratio%)',
      );
