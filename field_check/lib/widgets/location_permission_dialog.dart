      ...
      builder: (context) => AlertDialog(
        ...
        content: const Column(
          ...
          children: [
            ...
            Text('3. Tap "Location"'),
            Text('4. Select "Allow while using the app" or "Allow all the time"'),
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 12),
            _buildFeaturePoint(theme, Icons.check_circle_outline, 'Track employee location for real-time updates'),
            _buildFeaturePoint(theme, Icons.check_circle_outline, 'Verify geofence check-ins and check-outs'),
            _buildFeaturePoint(theme, Icons.check_circle_outline, 'Generate accurate location-based reports'),
