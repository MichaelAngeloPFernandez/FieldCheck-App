...
router.post('/user-task/:userTaskId/submit', protect, submitUserTask);
router.post('/user-task/:userTaskId/approve', protect, admin, approveUserTask);
router.post('/user-task/:userTaskId/reject', protect, admin, rejectUserTask);
